...
import { MdPlace , MdEmojiTransportation, MdOutlineAttachMoney} from "react-icons/md"
        ...
        <ContainerModal>
            <Container>
                <header>
                    ...
                    <button className="buttonClose" onClick={() => setModalJobDetail(false)}><GrClose /></button>    
                </header>
                ...
                <div className="modalContent">
                    ...
                    <section className="jobDetails">
                        <div>
                            <p><AiOutlineThunderbolt style={style} /> {job?.level}</p>
                            <p><MdPlace style={style}  /> {job?.place}</p>
                            <p><MdEmojiTransportation style={style} />{job?.type}</p>
                            <p><MdOutlineAttachMoney style={style} /> {job?.salary}</p>
